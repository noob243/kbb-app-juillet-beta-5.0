...
const InvoiceDetailModal: FC<InvoiceDetailModalProps> = ({ isOpen, onClose, invoice, cases, clients, onSendEmail }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-[70] flex justify-center items-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl p-0 max-w-3xl w-full border border-gray-200 overflow-hidden animate-fadeIn my-8">
        
        {/* Top Control Header */}
        <div className="bg-slate-100 border-b border-gray-200 px-6 py-4 flex justify-between items-center bg-gray-50">
