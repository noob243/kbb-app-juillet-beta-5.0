    ...
    <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-2xl shadow-2xl border border-slate-200 w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="px-6 py-4 bg-slate-50 border-b border-slate-200 flex justify-between items-center shrink-0">
          ...
          <button 
            onClick={onClose} 
            className="text-gray-400 hover:text-gray-600 transition p-1 hover:bg-slate-100 rounded-lg"
          >
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          ...
          {type === 'avocat' && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="md:col-span-2 flex items-center gap-4 p-3 bg-slate-50 dark:bg-[#121b2d] rounded-2xl border border-slate-200 dark:border-[#1e293b]">
              ...
              <div className="md:col-span-2 border border-slate-200 p-4 rounded-2xl bg-indigo-50/15">
                <div className="flex justify-between items-center pb-2 border-b border-indigo-100 mb-3">
                  ...
                  <button 
                    ...
                    className="bg-white hover:bg-indigo-50 border border-indigo-200 text-indigo-900 text-[10px] font-black px-2.5 py-1.5 rounded-lg uppercase transition"
                  >
                    + Ajouter un compte
                  </button>
                </div>
                    ...
                    {formData.bankAccounts.map((acc: any, index: number) => (
                      <div key={index} className="flex gap-2 items-center bg-white p-2.5 rounded-xl border border-gray-200">
                        ...
                        <button 
                          ...
                          className="p-2 bg-red-50 hover:bg-red-100 border border-red-200 text-red-600 rounded-xl text-xs font-bold self-end shrink-0"
          ...
          {type === 'client' && (
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-3 bg-slate-50 dark:bg-[#121b2d] rounded-2xl border border-slate-200 dark:border-[#1e293b]">
                <div className="relative w-16 h-16 rounded-full bg-slate-200 dark:bg-[#0d1524] overflow-hidden border border-slate-300 dark:border-slate-700 flex items-center justify-center">
                  {formData.logoUrl ? (
              ...
              <div className="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4 border border-rose-150 p-4 rounded-xl bg-rose-50/10">
                ...
                <div>
                  ...
                  <input 
                    ...
                    className="w-full p-2 border border-slate-300 rounded-xl text-xs font-semibold focus:ring-2 focus:ring-indigo-500/15 text-rose-800"
                    placeholder="..."
                  />
                </div>
              </div>
          ...
          <div className="mt-8 pt-6 border-t border-slate-200">
            ...
            <div className="border-2 border-dashed border-slate-300 rounded-2xl p-6 bg-slate-50 hover:bg-indigo-50/20 transition text-center relative cursor-pointer group">
              ...
              <div className="flex flex-col items-center justify-center gap-2">
                  <div className="w-10 h-10 bg-white shadow-2xs border border-slate-200 rounded-full flex items-center justify-center text-indigo-600 group-hover:scale-115 transition">
                    ...
                    <div className="flex gap-1.5 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                      {file.content && (
                        <a 
                          href={file.content} 
                          download={file.name}
                          className="w-7 h-7 bg-indigo-50 border border-indigo-150 text-indigo-700 hover:bg-indigo-600 hover:text-white rounded-lg flex items-center justify-center text-xs transition shadow-2xs"
                          title="Télécharger"
                        >
                        ...
                        className="w-7 h-7 bg-rose-50 border border-rose-150 text-rose-600 hover:bg-rose-600 hover:text-white rounded-lg flex items-center justify-center text-xs transition shadow-2xs"
                        title="Supprimer"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
