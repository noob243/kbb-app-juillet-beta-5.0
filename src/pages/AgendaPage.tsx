            ...
            >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-xs flex items-center justify-between">
                        <div className="space-y-1">
                            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Tâches Terminées</span>
                    ...
                    <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-xs flex items-center justify-between">
                        <div className="space-y-1">
                            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Tâches à Venir</span>
                            <div className="flex items-baseline gap-2">
                    ...
                    <div className="bg-white p-5 rounded-2xl border border-gray-200 shadow-xs flex items-center justify-between">
                        <div className="space-y-1">
                            <span className="text-[11px] font-bold text-slate-400 uppercase tracking-wider block">Événements Cabinet</span>
                            <div className="flex items-baseline gap-2">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                    <div className="flex items-center space-x-2 bg-slate-100 p-1 rounded-xl border border-slate-200 w-fit">
                        <button 
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-1.5 ${activeView === 'calendar' ? 'bg-white shadow-sm text-indigo-700' : 'text-gray-500 hover:text-gray-800'}`}
                        >
                        ...
                        <button 
                            ...
                            className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all flex items-center gap-1.5 ${activeView === 'list' ? 'bg-white shadow-sm text-indigo-700' : 'text-gray-500 hover:text-gray-800'}`}
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                {activeView === 'calendar' ? (
                    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                        {/* Month bar */}
                        <div className="p-4 flex flex-col sm:flex-row justify-between items-center gap-4 bg-slate-50 border-b border-gray-200">
                        ...
                        <div className="grid grid-cols-7 bg-slate-100 text-center border-b border-gray-200">
                            {WEEKDAYS.map(day => (
                                            ...
                                            <React.Fragment key={task.id}>
                                                <tr className={`transition-colors border-b border-gray-100 ${
                                                    ...
                                                    <td className="p-4 align-middle text-center w-12">
                                                        ...
                                                        >
                                                            <svg 
                                                                className={`w-5 h-5 transform transition-transform duration-200 ${isExpanded ? 'rotate-90 text-indigo-650' : 'text-gray-400'}`}
                                                                fill="none" 
                                                                viewBox="0 0 24 24" 
                                                                stroke="currentColor"
                                                            >
                                                    ...
                                                    <td className="p-4 align-middle">
                                                        <div className="flex flex-col">
                                                            ...
                                                            <div className="flex flex-wrap items-center gap-2 mt-1 text-[11px] text-gray-400 font-medium">
                                                                ...
                                                                {task.rapport && (
                                                                    <span className="flex items-center gap-1 text-indigo-500" title="Contient un rapport">
                                                    ...
                                                    <td className="p-4 text-sm align-middle">
                                                        <div className="flex flex-col text-xs space-y-0.5">
                                                            ...
                                                            <span className={`font-semibold text-sm ${late ? 'text-red-600 font-bold' : 'text-gray-700'}`}>
                                                                        ...
                                                                        <div className="space-y-2 text-xs">
                                                                            ...
                                                                            {task.procedureLinked && (
                                                                                <div className="flex justify-between items-start py-0.5">
                                                                                    ...
                                                                                    <span className="font-bold text-gray-800 bg-indigo-50 px-2 py-0.5 rounded border border-indigo-100 text-right max-w-[200px] truncate">
                                                                                        {task.procedureLinked}
                                                                                    </span>
                                                                                </div>
                                                                            )}
                                    ...
                                    {finalEvents.length > 0 ? (
                                        finalEvents.map(ev => (
                                            <tr key={ev.id} className="hover:bg-slate-50/50 transition-colors">
                                                <td className="p-4 align-middle">
                                                    <span className="font-bold text-gray-800 hover:text-purple-700 cursor-pointer block" onClick={() => setSelectedEventForModal(ev)}>
                                                        {ev.name}
                                                    </span>
                                                </td>
                                                <td className="p-4 align-middle">
                                                ...
                                                <td className="p-4 align-middle text-xs text-gray-700 font-semibold">
                            ...
                            <div className="space-y-4 text-sm">
                                ...
                                {relatedCase && (
                                    <div>
                                        ...
                                        <div className="p-2.5 bg-slate-50 border border-gray-200 rounded-xl flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex flex-wrap gap-1.5">
                                            {selectedTaskForModal.associatedLawyers.map(l => (
                                                <span key={l} className="px-2 py-0.5 bg-indigo-50 text-indigo-700 text-xs font-bold rounded-lg border border-indigo-100">
                                                    {l}
                                                </span>
                                            ))}
                                        </div>
                                ...
                                <div className="p-4 bg-indigo-50/40 rounded-2xl border border-indigo-100/50 space-y-3 mt-4 text-left">
                                    ...
                                    <div className="flex items-center justify-between bg-white text-gray-800 p-2.5 rounded-xl border border-gray-200">
