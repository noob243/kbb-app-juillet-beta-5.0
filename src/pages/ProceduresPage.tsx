  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white dark:bg-[#0e1726] p-5 rounded-2xl border border-gray-200 dark:border-slate-800/60 shadow-xs flex items-center space-x-4">
      ...
      <div className="bg-white dark:bg-[#0e1726] border border-gray-200 dark:border-slate-800/60 p-4 rounded-2xl shadow-xs flex flex-col md:flex-row gap-4 items-center justify-between">
      ...
      {filteredProcedures.length === 0 ? (
        <div className="bg-white dark:bg-[#0e1726] border border-gray-200 dark:border-slate-800/60 rounded-2xl p-12 text-center shadow-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {filteredProcedures.map((proc) => (
            <div 
              key={proc.id} 
              className="bg-white dark:bg-[#0e1726] border border-gray-200 dark:border-slate-800/50 hover:border-slate-300 dark:hover:border-slate-700 rounded-2xl p-5 shadow-xs transition duration-300 relative flex flex-col justify-between"
            >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 z-50 flex justify-center items-center backdrop-blur-xs">
          <div className="bg-white dark:bg-[#0e1726] rounded-2xl shadow-2xl p-6 max-w-lg w-full max-h-[90vh] overflow-y-auto border border-gray-200 dark:border-slate-800">
