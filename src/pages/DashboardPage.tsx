            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 pb-5">
                ...
                <div className="flex bg-slate-100 p-1 rounded-xl self-start sm:self-center border border-slate-150">
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2 ${dashboardMode === 'overview' ? 'bg-white text-[#15447c] shadow-xs' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-xs font-black uppercase tracking-wider transition-all flex items-center gap-2 ${dashboardMode === 'analytics' ? 'bg-white text-[#15447c] shadow-xs' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                        <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                                        ...
                                        <div className="flex items-start justify-between gap-4">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-[10px] text-gray-500 font-bold">{lawyer.cabinetRole || 'Collaborateur'}</p>
                                                </div>
                                            </div>
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5">
                            ...
                            <div className="flex bg-slate-100 p-1 rounded-xl self-start sm:self-center">
                                <button
                                    ...
                                    className={`px-3 py-1 rounded-lg text-3xs font-black uppercase tracking-wider transition ${financeTab === 'cases' ? 'bg-white text-gray-800 shadow-3xs' : 'text-gray-500 hover:text-gray-700'}`}
                                >
                                    Par Dossier
                                </button>
                                <button
                                    onClick={() => setFinanceTab('clients')}
                                    className={`px-3 py-1 rounded-lg text-3xs font-black uppercase tracking-wider transition ${financeTab === 'clients' ? 'bg-white text-gray-800 shadow-3xs' : 'text-gray-500 hover:text-gray-700'}`}
                                >
                                    Par Client
                                </button>
                            </div>
                                            ...
                                            <div className="flex items-start justify-between gap-4">
                                                <div>
                                                    ...
                                                    <div className="flex items-center gap-1.5 mt-1">
                                                        <span className="text-[10px] font-bold text-gray-400">{c.client}</span>
                            ...
                            <div className="space-y-2.5">
                                ...
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full px-3 py-1.5 bg-white border border-gray-200 rounded-lg text-xs focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none font-medium text-gray-800"
                                    />
                                </div>
