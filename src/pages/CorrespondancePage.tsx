...
export const CorrespondancePage: FC<CorrespondancePageProps> = ({ 
    ...
    const handleSaveCorrespondence = async (e?: React.FormEvent) => {
        ...
        try {
            if (isEditing) {
                await dbUpdateDoc<Correspondance>('correspondances', id, data);
    ...
    const handleSendViaEmail = async (corr: Correspondance) => {
        ...
        try {
            ...
            await dbUpdateDoc<Correspondance>('correspondances', corr.id, updated);
                    ...
                    <div className="space-y-3 pb-4 border-b border-gray-150 dark:border-[#1e293b]/70">
                        <div className="relative">
                            <input
                                ...
                                className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#121b2d] text-sm text-slate-800 dark:text-slate-200 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500"
                            />
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <select
                                    ...
                                    className="w-full mt-1 px-2.5 py-1.5 rounded-lg border border-gray-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#121b2d] text-xs text-slate-700 dark:text-slate-200 focus:outline-none"
                                >
                                    ...
                                    >
                                        <div className="flex justify-between items-start gap-2">
                                            <span className="px-2 py-0.5 rounded-md text-[10px] font-bold tracking-wider uppercase bg-indigo-50 text-indigo-600 dark:bg-indigo-950/20 dark:text-indigo-400 border border-indigo-200/50 dark:border-indigo-900/30">
                                                ✍️ {corr.avocatSignataireId ? (avocats.find(a => a.id === corr.avocatSignataireId)?.fullName || 'Lettre') : 'Non signée'}
                                            </span>
                                    ...
                                    <div className="grid grid-cols-2 gap-3.5">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full mt-1.5 px-3 py-2 rounded-xl border border-gray-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#121b2d] text-xs text-slate-700 dark:text-slate-200 focus:outline-none"
                                            >
                                    ...
                                    <div className="grid grid-cols-2 gap-3.5">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full mt-1.5 px-3 py-2 rounded-xl border border-gray-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#121b2d] text-xs text-slate-800 dark:text-slate-150 focus:outline-none"
                                            />
                                        </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-3.5">
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                rows={2}
                                                className="w-full mt-1.5 px-3 py-2 rounded-xl border border-gray-200 dark:border-[#1e293b] bg-slate-50 dark:bg-[#121b2d] text-xs text-slate-800 dark:text-slate-200 focus:outline-none"
                                            />
                                        </div>
                                    </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 rounded-xl border border-gray-150 dark:border-[#1e293b] bg-white dark:bg-[#0d1524]">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-xs font-bold text-indigo-600 dark:text-indigo-400 mt-1 block">
                                            {selectedCorr.avocatSignataireId ? (avocats.find(a => a.id === selectedCorr.avocatSignataireId)?.fullName || 'Avocat non trouvé') : 'Aucun avocat associé'}
                                        </span>
                                    </div>
                                    <div>
