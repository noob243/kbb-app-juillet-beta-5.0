...
const GestionPage: FC<GestionPageProps> = (props) => {
    ...
    const deleteButtonClass = "font-extrabold text-rose-600 hover:text-rose-800 bg-rose-50 hover:bg-rose-100 px-2 py-1.5 rounded-lg transition";
    ...
    const cancelButtonClass = "font-extrabold text-gray-500 hover:text-gray-750 bg-gray-100 hover:bg-gray-200 px-2.5 py-1.5 rounded-lg transition border border-gray-200";

    // Synchronized Users (RBAC) with Firestore / Local Storage
    ...
    const handleUpdateCorrespondance = async (updated: Correspondance) => {
        try {
            ...
            await dbUpdateDoc<Correspondance>('correspondances', id, properties);
                ...
                <div className="flex flex-col md:flex-row gap-4">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 border border-slate-200 rounded-xl text-xs font-semibold focus:ring-2 focus:ring-indigo-500/15 focus:border-indigo-500/80 bg-slate-50/30 outline-none transition"
                        />
                    </div>
                    <div className="md:w-72 shrink-0">
                        <select
                            ...
                            className="w-full p-2.5 border border-slate-200 rounded-xl text-xs font-black text-[#15447c] focus:ring-2 focus:ring-indigo-500/15 bg-white cursor-pointer outline-none transition"
                        >
                                                ...
                                                <>
                                                    <td className={tableCellClass}>
                                                        <input 
                                                            ...
                                                            className="p-1.5 border border-indigo-400/50 rounded-lg text-xs font-bold w-full bg-white shadow-inner focus:ring-2 focus:ring-indigo-500/10 focus:outline-none"
                                                        />
                                                    </td>
                                                    <td className={tableCellClass}>
                                                        <select 
                                                            ...
                                                            className="p-1.5 border border-indigo-400/50 rounded-lg text-2xs font-bold w-full bg-white focus:outline-none"
                                                        >
