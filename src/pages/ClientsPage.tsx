                            ...
                            <div className="flex justify-between items-start mb-6 border-b border-slate-100 pb-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <h2 className="text-xl font-black text-slate-800 leading-tight">{selectedClient.name}</h2>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <div className="text-xs font-bold text-slate-800 flex items-center gap-2 bg-slate-50/75 px-3 py-2 rounded-xl border border-slate-100">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs text-slate-700 font-semibold p-3 bg-slate-50 border border-slate-100 rounded-xl space-y-2">
                                            ...
                                            <p className="flex items-center justify-between gap-2 border-t border-slate-150/50 pt-2">
                                                ...
                                                <button
                                                    ...
                                                    className="text-3xs bg-indigo-100/60 hover:bg-indigo-100 text-indigo-800 font-bold px-2.5 py-1 rounded-lg transition shrink-0 cursor-pointer"
                                                >
                                                    📩 Écrire
                                                </button>
                                            </p>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        <h4 className="text-3xs font-black text-slate-400 uppercase tracking-widest mb-2 flex items-center gap-1.5">
                                            <Scale className="w-3.5 h-3.5 text-indigo-500" /> Procédures administratives ({activeProcedures.length})
                                        </h4>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-slate-50 border border-slate-150/60 rounded-xl p-3.5 text-2xs space-y-2">
                                            ...
                                            <div className="flex justify-between border-b border-slate-150/50 pb-1.5 font-medium">
                                                <span className="text-slate-400 text-emerald-600">Acomptes Encaissés :</span>
                                                ...
                                                {caseTasks.map(t => (
                                                    <div key={t.id} className="p-2.5 bg-slate-50 border border-slate-100 rounded-xl text-3xs flex items-center justify-between">
                                                        ...
                                                        <span className={`px-2 py-0.5 rounded text-[8px] font-black uppercase ${
                                                            t.status === 'Effectué' ? 'bg-emerald-50 text-emerald-700 border border-emerald-100' :
